...
public class MainPageObject
{
    ...
    public WebElement waitForElementPresence(By by, String error_message, long timeoutInSeconds)
    {
    ...
    public WebElement waitForElementPresence(By by, String error_message)
    {
